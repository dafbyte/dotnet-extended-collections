...
{
	public struct KeyValuePair<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6, TValue>
	{
		public KeyValuePair(TKey1 key1, TKey2 key2, TKey3 key3, TKey4 key4, TKey5 key5, TKey6 key6, TValue value) : this()
		{
			Key = new Tuple<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6>(key1, key2, key3, key4, key5, key6);
			Value = value;
		}
		...
		/// <see cref="KeyValuePair{TKey1,TKey2,TKey3,TKey4,TKey5,TKey6,TValue}"/>.
		/// </returns>
		...
		/// <returns>
		/// A <see cref="Tuple{TKey1,TKey2,TKey3,TKey4,TKey5,TKey6}"/> that is the key of the
		/// <see cref="KeyValuePair{TKey1,TKey2,TKey3,TKey4,TKey5,TKey6,TValue}"/>.
		/// </returns>
		public Tuple<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6> Key { get; }
		/// <summary>
		/// Gets the value in the key/value pair.
		/// </summary>
		/// <returns>
		/// A TValue that is the value of the <see cref="KeyValuePair{TKey1,TKey2,TKey3,TKey4,TKey5,TKey6,TValue}"/>.
		/// </returns>
		...
		public static implicit operator KeyValuePair<Tuple<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6>, TValue>(
			KeyValuePair<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6, TValue> src)
		{
			var key =
				new Tuple<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6>(src.Key1, src.Key2, src.Key3, src.Key4, src.Key5, src.Key6);
			return new KeyValuePair<Tuple<TKey1, TKey2, TKey3, TKey4, TKey5, TKey6>, TValue>(key, src.Value);
		}
	}
}
