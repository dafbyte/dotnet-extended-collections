...
namespace TupleCollections
{
		...
		ICollection<KeyValuePair<TKey1, TKey2, TValue>>
	{
		...
		/// The property is set and the <see cref="IDictionary{TKey1, TKey2, TValue}"/>
		/// is read-only.
		/// </exception>
		TValue this[TKey1 key1, TKey2 key2] { get; set; }

		/// <summary>
		/// Gets an <see cref="ICollection{TKey1,TKey2}"/> containing the keys of
		/// the <see cref="IDictionary{TKey1,TKey2,TValue}"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IDictionary{TKey1,TKey2,TValue}"/> containing the keys of
		/// the object that implements <see cref="ICollection{TKey1,TKey2}"/>.
		/// </returns>
		new ICollection<TKey1, TKey2> Keys { get; }

		/// <summary>
		/// Adds an element with the provided key and value to the
		/// <see cref="IDictionary{TKey1,TKey2,TValue}"/>.
		/// </summary>
		...
		/// An element with the same key already exists in the <see cref="IDictionary{TKey1,TKey2,TValue}"/>.
		/// </exception>
		/// <exception cref="NotSupportedException">
		/// The <see cref="IDictionary{TKey1,TKey2,TValue}"/> is read-only.
		/// </exception>
		void Add(TKey1 key1, TKey2 key2, TValue value);

		/// <summary>
		/// Determines whether the <see cref="IDictionary{TKey1,TKey2,TValue}"/> contains
		...
		/// </param>
		/// <returns>
		/// true if the <see cref="IDictionary{TKey1,TKey2,TValue}"/> contains
		...
		/// found in the original <see cref="IDictionary{TKey1,TKey2,TValue}"/>.
		/// </returns>
		/// <exception cref="NotSupportedException">
		/// The <see cref="IDictionary{TKey1,TKey2,TValue}"/> is read-only.
		/// </exception>
		...
		/// <see cref="IDictionary{TKey1,TKey2,TValue}"/> contains an element with
