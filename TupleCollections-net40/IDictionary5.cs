...
namespace TupleCollections
{
	...
	public interface IDictionary<TKey1, TKey2, TKey3, TKey4, TKey5, TValue> :
		//IDictionary<Tuple<TKey1, TKey2, TKey3, TKey4, TKey5>, TValue>,
		ICollection<KeyValuePair<TKey1, TKey2, TKey3, TKey4, TKey5, TValue>>
	{
		/// <summary>
		...
		/// The property is set and the <see cref="IDictionary{TKey1, TKey2, TKey3, TKey4, TKey5, TValue}"/>
		/// is read-only.
		/// </exception>
		TValue this[TKey1 key1, TKey2 key2, TKey3 key3, TKey4 key4, TKey5 key5] { get; set; }

		/// <summary>
		/// Gets an <see cref="ICollection{TKey1,TKey2,TKey3,TKey4,TKey5}"/> containing the keys of
		/// the <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/>.
		/// </summary>
		/// <returns>
		/// An <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/> containing the keys of
		/// the object that implements <see cref="ICollection{TKey1,TKey2,TKey3,TKey4,TKey5}"/>.
		/// </returns>
		new ICollection<TKey1, TKey2, TKey3, TKey4, TKey5> Keys { get; }

		/// <summary>
		/// Adds an element with the provided key and value to the
		/// <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/>.
		/// </summary>
		...
		/// An element with the same key already exists in the <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/>.
		/// </exception>
		/// <exception cref="NotSupportedException">
		/// The <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/> is read-only.
		/// </exception>
		void Add(TKey1 key1, TKey2 key2, TKey3 key3, TKey4 key4, TKey5 key5, TValue value);

		/// <summary>
		/// Determines whether the <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/> contains
		...
		/// </param>
		/// <returns>
		/// true if the <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/> contains
		/// an element with the key; otherwise, false.
		/// </returns>
		bool ContainsKey(TKey1 key1, TKey2 key2, TKey3 key3, TKey4 key4, TKey5 key5);
		...
		/// found in the original <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/>.
		/// </returns>
		/// <exception cref="NotSupportedException">
		/// The <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/> is read-only.
		/// </exception>
		...
		/// <see cref="IDictionary{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/> contains an element with
