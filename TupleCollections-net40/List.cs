...
namespace TupleCollections
{
	...
	public class List<T1, T2, T3> : List<Tuple<T1, T2, T3>>, IList<T1, T2, T3>
	{
		...
		/// <summary>
		/// Searches the entire sorted <see cref="List{T1, T2, T3}"/> for an element using the
		/// default comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="item1">
		/// The first component of the object to locate. The value can be null for reference types.
		...
		/// </param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="List{T1, T2, T3}"/>, if item is
		/// found; otherwise, a negative number that is the bitwise complement of the index of the next element that is
		/// larger than item or, if there is no larger element, the bitwise complement of
		/// <see cref="List{T1, T2, T3}.Count"/>.
		/// </returns>
		/// <exception cref="InvalidOperationException">
		/// The default comparer <see cref="Comparer{T}.Default"/> cannot find an implementation of the
		/// <see cref="IComparable{T}"/> generic interface or the <see cref="IComparable"/> interface for type
		...
		/// </param>
		/// <param name="comparer">
		/// The <see cref="IComparer{Tuple{T1, T2, T3}}"/> implementation to use when comparing elements.
		/// -or- null to use the default comparer <see cref="Comparer{Tuple{T1, T2, T3}}.Default"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="List{T1, T2, T3}"/>,
		/// if item is found; otherwise, a negative number that is the bitwise complement of the index of the next
	...
	public class List<T1, T2, T3, T4, T5> : List<Tuple<T1, T2, T3, T4, T5>>, IList<T1, T2, T3, T4, T5>
	{
		...
		/// <summary>
		/// Searches the entire sorted <see cref="List{T1, T2, T3, T4, T5}"/> for an element using the
		/// default comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="item1">
		/// The first component of the object to locate. The value can be null for reference types.
		...
		/// </param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="List{T1, T2, T3, T4, T5}"/>, if item is
		/// found; otherwise, a negative number that is the bitwise complement of the index of the next element that is
		/// larger than item or, if there is no larger element, the bitwise complement of
		/// <see cref="List{T1, T2, T3, T4, T5}.Count"/>.
		/// </returns>
		/// <exception cref="InvalidOperationException">
		/// The default comparer <see cref="Comparer{T}.Default"/> cannot find an implementation of the
		/// <see cref="IComparable{T}"/> generic interface or the <see cref="IComparable"/> interface for type
		...
		/// <summary>
		/// Searches the entire sorted <see cref="List{T1, T2, T3, T4, T5}"/> for an element using the specified comparer
		/// and returns the zero-based index of the element.
		/// </summary>
		/// <param name="item1">
		/// The first component of the object to locate. The value can be null for reference types.
		...
		/// </param>
		/// <param name="comparer">
		/// The <see cref="IComparer{Tuple{T1, T2, T3, T4, T5}}"/> implementation to use when comparing elements.
		/// -or- null to use the default comparer <see cref="Comparer{Tuple{T1, T2, T3, T4, T5}}.Default"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="List{T1, T2, T3, T4, T5}"/>,
		/// if item is found; otherwise, a negative number that is the bitwise complement of the index of the next
	...
	public class List<T1, T2, T3, T4, T5, T6> : List<Tuple<T1, T2, T3, T4, T5, T6>>, IList<T1, T2, T3, T4, T5, T6>
	{
		...
		/// <summary>
		/// Searches the entire sorted <see cref="List{T1, T2, T3, T4, T5, T6}"/> for an element using the
		/// default comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="item1">
		/// The first component of the object to locate. The value can be null for reference types.
		...
		/// </param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="List{T1, T2, T3, T4, T5, T6}"/>, if item is
		/// found; otherwise, a negative number that is the bitwise complement of the index of the next element that is
		/// larger than item or, if there is no larger element, the bitwise complement of
		/// <see cref="List{T1, T2, T3, T4, T5, T6}.Count"/>.
		/// </returns>
		/// <exception cref="InvalidOperationException">
		/// The default comparer <see cref="Comparer{T}.Default"/> cannot find an implementation of the
		/// <see cref="IComparable{T}"/> generic interface or the <see cref="IComparable"/> interface for type
		...
		/// <summary>
		/// Searches the entire sorted <see cref="List{T1, T2, T3, T4, T5, T6}"/> for an element using the specified comparer
		/// and returns the zero-based index of the element.
		/// </summary>
		/// <param name="item1">
		/// The first component of the object to locate. The value can be null for reference types.
		...
		/// </param>
		/// <param name="comparer">
		/// The <see cref="IComparer{Tuple{T1, T2, T3, T4, T5, T6}}"/> implementation to use when comparing elements.
		/// -or- null to use the default comparer <see cref="Comparer{Tuple{T1, T2, T3, T4, T5, T6}}.Default"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="List{T1, T2, T3, T4, T5, T6}"/>,
		/// if item is found; otherwise, a negative number that is the bitwise complement of the index of the next
		...
		IList<T1, T2, T3, T4, T5, T6, T7>
	{
		...
		/// <summary>
		/// Searches the entire sorted <see cref="List{T1, T2, T3, T4, T5, T6, T7}"/> for an element using the
		/// default comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="item1">
		/// The first component of the object to locate. The value can be null for reference types.
		...
		/// </param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="List{T1, T2, T3, T4, T5, T6, T7}"/>, if item is
		/// found; otherwise, a negative number that is the bitwise complement of the index of the next element that is
		/// larger than item or, if there is no larger element, the bitwise complement of
		/// <see cref="List{T1, T2, T3, T4, T5, T6, T7}.Count"/>.
		/// </returns>
		/// <exception cref="InvalidOperationException">
		/// The default comparer <see cref="Comparer{T}.Default"/> cannot find an implementation of the
		/// <see cref="IComparable{T}"/> generic interface or the <see cref="IComparable"/> interface for type
		...
		/// <summary>
		/// Searches the entire sorted <see cref="List{T1, T2, T3, T4, T5, T6, T7}"/> for an element using the specified comparer
		/// and returns the zero-based index of the element.
		/// </summary>
		/// <param name="item1">
		/// The first component of the object to locate. The value can be null for reference types.
		...
		/// </param>
		/// <param name="comparer">
		/// The <see cref="IComparer{Tuple{T1, T2, T3, T4, T5, T6, T7}}"/> implementation to use when comparing elements.
		/// -or- null to use the default comparer <see cref="Comparer{Tuple{T1, T2, T3, T4, T5, T6, T7}}.Default"/>.
		/// </param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="List{T1, T2, T3, T4, T5, T6, T7}"/>,
		/// if item is found; otherwise, a negative number that is the bitwise complement of the index of the next
