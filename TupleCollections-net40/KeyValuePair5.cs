...
{
	public struct KeyValuePair<TKey1, TKey2, TKey3, TKey4, TKey5, TValue>
	{
		public KeyValuePair(TKey1 key1, TKey2 key2, TKey3 key3, TKey4 key4, TKey5 key5, TValue value) : this()
		{
			Key = new Tuple<TKey1, TKey2, TKey3, TKey4, TKey5>(key1, key2, key3, key4, key5);
			Value = value;
		}
		...
		/// <see cref="KeyValuePair{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/>.
		/// </returns>
		...
		/// <returns>
		/// A <see cref="Tuple{TKey1,TKey2,TKey3,TKey4,TKey5}"/> that is the key of the
		/// <see cref="KeyValuePair{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/>.
		/// </returns>
		public Tuple<TKey1, TKey2, TKey3, TKey4, TKey5> Key { get; }
		/// <summary>
		/// Gets the value in the key/value pair.
		/// </summary>
		/// <returns>
		/// A TValue that is the value of the <see cref="KeyValuePair{TKey1,TKey2,TKey3,TKey4,TKey5,TValue}"/>.
		/// </returns>
		...
		public static implicit operator KeyValuePair<Tuple<TKey1, TKey2, TKey3, TKey4, TKey5>, TValue>(
			KeyValuePair<TKey1, TKey2, TKey3, TKey4, TKey5, TValue> src)
		{
			var key = new Tuple<TKey1, TKey2, TKey3, TKey4, TKey5>(src.Key1, src.Key2, src.Key3, src.Key4, src.Key5);
			return new KeyValuePair<Tuple<TKey1, TKey2, TKey3, TKey4, TKey5>, TValue>(key, src.Value);
		}
	}
}
